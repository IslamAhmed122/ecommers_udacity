...
public class AddToCartDefinition {
    ...
    {
        driver.navigate().to("https://www.egymerch.com/en/cart");
        String expected ="Custom product made by you!";
        String actual = login.getElementByPath("/html/body/main/main/section/div/div/div/div[1]/table/tbody/tr/td[2]/h5]").getText();
